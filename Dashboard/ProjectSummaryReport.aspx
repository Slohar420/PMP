<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProjectSummaryReport.aspx.cs" MasterPageFile="~/Dashboard/DSMaster.master" Inherits="Dashboard" %>
...
<asp:Content ID="head" ContentPlaceHolderID="mainContent" runat="server">
                ...
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
                            <label id="ReportHeading" style="font-weight: 800; font-size: 20px; color: #0e4e93; margin-bottom: 20px; margin-top: 5px; font-family: Georgia, 'Times New Roman', Times, serif;">Project Summary Report</label>
                        </div>

                    </div>
                    <div class="card" style="margin-left: 30px">
                        <div class="card-header" style="height: auto; color: black; padding-left: 0">
                             <div class="col-md-2 col-lg-2 col-sm-12 col-xs-12" id="divFilterByUserType"  >
                                <label for="psw-repeat" style="margin-left: -56px;"><b>Filter By Status</b></label>
                            ...
                            <div class="col-md-2 col-lg-2 col-sm-12 col-xs-12" id="divsearch" style="margin-top: 20px;">
                                <button style="background-color: #00a65a;" id="btnSearch" type="button" onclick="projectSummaryReport()" class="btn btn-success form-control">Search</button>
                            </div>
    ...
    <script>
        $(document).ready(function () {
            var data = "";
            projectSummaryReport(data);

        })
        
        function projectSummaryReport(data) {
            debugger;
            if (data == undefined)
                data = "";
            var fdate = $("#" + "<%=txtFromDate.ClientID%>").val();
            var tdate = $("#" + "<%=txtToDate.ClientID%>").val();
            var data = data + "#" + fdate +  "#" + tdate
            $.ajax({
                type: "POST",
                url: "ProjectSummaryReport.aspx/getProjectData",
                data: "{data : '" + data + "'}",
