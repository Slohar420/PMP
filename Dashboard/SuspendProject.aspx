<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SuspendProject.aspx.cs" MasterPageFile="~/Dashboard/DSMaster.master" Inherits="Dashboard" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="mainContent" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function loadProjects() {
            ...
            $.ajax({
                type: "POST",
                url: "SuspendProject.aspx/getSuspendProject", //It calls our web method  
                contentType: "application/json; charset=utf-8",
                data: "{}",
                dataType: "json",
                success: function (data) {
                        ...
                        success: function (e) {
                            ...
                            if (e.d == "true") {
                                swal({
                                    ...
                                    window.location = "SuspendProject.aspx";
                                });
                            } else {
                                swal({
