...
public partial class Dashboard : System.Web.UI.Page
{
    ...
    protected void btnPdfExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            dTable = dtPdetails;
            Heading = "EMPLOYEE WISE PROJECT DETAILS REPORT GENERATED ON";
            filename = "Employee_Wise_Project_Details_Report_";
    ...
    public static List<projectDetails> getProjectReportUserWise(string data)
    {
        ...
        try
        {
            ...
            var res = webClient.UploadString(URL + "/GetProjectDetailsUserWise", "POST", data);
            ...
            if (objReply.isValid)
            {
                ...
                dtPdetails.Columns.Add("Designation");
                dtPdetails.Columns.Add("Employee Type");
                dtPdetails.Columns.Add("Project Name");
                dtPdetails.Columns.Add("Task");
                dtPdetails.Columns.Add("Staus");
                ...
                foreach (DataRow item in objReply.DS.Tables[0].Rows)
                {
                    ...
                    if (objReply.DS.Tables[0].Rows[i]["duedate"].ToString() != "" && objReply.DS.Tables[0].Rows[i]["submission_date"].ToString() != "")
                    {
                        ...
                        Double days = (SubmissionDate - DueDate).TotalDays;
                    ...
                    if (i != 0 && objReply.DS.Tables[0].Rows[i]["user_name"].ToString() == objReply.DS.Tables[0].Rows[i - 1]["user_name"].ToString())
                    {
                    ...
                    else
                    {
                        ...
                        Desgination = objReply.DS.Tables[0].Rows[i]["designation"].ToString();
                        Usertype = objReply.DS.Tables[0].Rows[i]["UserType"].ToString();
                    }


                    DataRow drow = dtPdetails.NewRow();
                    drow["Employee Name"] = username;
                    drow["Designation"] = Desgination;
                    drow["Employee Type"] = Usertype;
                    drow["Project Name"] = projectName;
                    drow["Task"] = objReply.DS.Tables[0].Rows[i]["task_name"].ToString();
                    drow["Staus"] = objReply.DS.Tables[0].Rows[i]["task_status"].ToString();
        ...
        {
            Log.Write("Exception  in EmployeeProjectDetails " + ex.ToString(), "");
        }
